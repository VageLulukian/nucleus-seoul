...
export const FINAL = {
  arrival: { label: 'ARRIVAL LOGGED:', value: 'SEOUL' },       // [КАНОН] журнал прибытия
  match: 'LOCATION MATCHES FORECAST',                           // [КАНОН] система была права
  comfort: { label: 'USER COMFORT:', value: 'OUT OF SCOPE' },   // [КАНОН] добивочная строка
};
